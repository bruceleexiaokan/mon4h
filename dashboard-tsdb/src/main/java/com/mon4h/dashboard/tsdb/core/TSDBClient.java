                ...
                for (NameSpaceConfig nscfg : nscfgs) {
                    if (nscfg.hbase != null) {
                        ...
                        if (nscfg.hbase.isMeta) {
                            TSDBClient.setMetaTSDBInfo(nscfg.hbase.zkquorum, nscfg.hbase.basePath, nscfg.tableName);
                            HTablePool pool = initTablePool(nscfg.hbase.zkquorum, nscfg.hbase.basePath);
                            writer = new MetricTagWriter(pool, nscfg.tableName);
                        }
                        else if (nscfg.hbase.isUnique) {
                            TSDBClient.setUniquesTSDBInfo(nscfg.hbase.zkquorum, nscfg.hbase.basePath, nscfg.tableName);
                            uniqueConfig = nscfg;
                        } else {
