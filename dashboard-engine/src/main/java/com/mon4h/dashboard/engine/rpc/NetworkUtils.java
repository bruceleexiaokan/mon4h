...
//import com.ctrip.search.logging.ESLogger;
//import com.ctrip.search.logging.Loggers;
 ...
 * @Version 1.0
 * 
 * @Create-at 2011-9-7 19:50:48
 * 
 * @Modification-history
 * <br>Date					Author		Version		Description
 * <br>----------------------------------------------------------
 * <br>2011-9-7 19:50:48  	li_yao		1.0			Newly created
 */
public class NetworkUtils {
//	private final static ESLogger logger = 
//		Loggers.getLogger(NetworkUtils.class);
	
	private static String localIP;
	
	private static boolean validLocalIP(String ip){
	...
	public static String getLocalIP() throws SocketException{
		...
		synchronized (NetworkUtils.class) {
			...
			while (intfs.hasMoreElements()) {
				...
				address = getFirstNonLoopbackAddress(intf, StackType.IPv4);
				if (address != null && validLocalIP(address.getHostAddress())) {
					return localIP = address.getHostAddress();
				}
			}
...
//		return null;
	...
	public static InetAddress getFirstNonLoopbackAddress(NetworkInterface intf,
		...
		for (Enumeration<InetAddress> addresses = intf.getInetAddresses(); addresses
				.hasMoreElements();) {
