...
public class HighCostTask implements Runnable{
	private Command<CommandResponse> command;
	@SuppressWarnings("unused")
	private InputAdapter inputAdapter;
	private OutputAdapter outputAdapter;
	
	public HighCostTask(Command<CommandResponse> command,InputAdapter inputAdapter,OutputAdapter outputAdapter){
