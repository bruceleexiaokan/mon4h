...
import com.ctrip.dashboard.tsdb.core.Span;
...
public class Util {
	...
	public static DataPoints getDataPointsFromSpan(List<Long> timePoints,int maxPointsCount,StreamSpan span,String interval,DownSampler downsampler){
		...
		if(span != null){
			...
			while(it.hasNext()){
				com.ctrip.dashboard.tsdb.core.DataPoint dp = it.next();
				if(!dp.isInteger()){
					isdouble = true;
				}
				if(dp.isInteger()){
	...
	public static DataPoints getDataPointsFromSpan(long baseTime,long endTime,int maxPointsCount,Span span,int interval,DownSampler downsampler){
		...
		if(span != null){
			...
			com.ctrip.dashboard.tsdb.core.DataPoint predp = null;
			com.ctrip.dashboard.tsdb.core.DataPoint dp = null;
			boolean isdouble = false;
			while(true){
				Object value = null;
				if(dp == null){
	...
	public static Object getDivValue(com.ctrip.dashboard.tsdb.core.DataPoint predp,com.ctrip.dashboard.tsdb.core.DataPoint dp,long timestamp){
		double prevalue = 0;
		if(predp.isInteger()){
	...
	public static Object getDivValue(com.ctrip.dashboard.tsdb.core.DataPoint start,long endtime,long timestamp){
		if(start.isInteger()){
