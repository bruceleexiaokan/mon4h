            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.logEvents = new ArrayList<LogEvent>(_list34.size);
                for (int _i35 = 0; _i35 < _list34.size; ++_i35)
                {
                  LogEvent _elem36; // required
                  _elem36 = new LogEvent();
                  _elem36.read(iprot);
                  struct.logEvents.add(_elem36);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.spans = new ArrayList<Span>(_list37.size);
                for (int _i38 = 0; _i38 < _list37.size; ++_i38)
                {
                  Span _elem39; // required
                  _elem39 = new Span();
                  _elem39.read(iprot);
                  struct.spans.add(_elem39);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.metrics = new ArrayList<MetricEvent>(_list40.size);
                for (int _i41 = 0; _i41 < _list40.size; ++_i41)
                {
                  MetricEvent _elem42; // required
                  _elem42 = new MetricEvent();
                  _elem42.read(iprot);
                  struct.metrics.add(_elem42);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.events = new ArrayList<Event>(_list43.size);
                for (int _i44 = 0; _i44 < _list43.size; ++_i44)
                {
                  Event _elem45; // required
                  _elem45 = new Event();
                  _elem45.read(iprot);
                  struct.events.add(_elem45);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Chunk struct) throws org.apache.thrift.TException {
      ...
      if (struct.logEvents != null) {
        oprot.writeFieldBegin(LOG_EVENTS_FIELD_DESC);
        {
          ...
          for (LogEvent _iter46 : struct.logEvents)
          {
            _iter46.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.metrics != null) {
        oprot.writeFieldBegin(METRICS_FIELD_DESC);
        {
          ...
          for (MetricEvent _iter48 : struct.metrics)
          {
            _iter48.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.events != null) {
        oprot.writeFieldBegin(EVENTS_FIELD_DESC);
        {
          ...
          for (Event _iter49 : struct.events)
          {
            _iter49.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetLogEvents()) {
        {
          ...
          for (LogEvent _iter50 : struct.logEvents)
          {
            _iter50.write(oprot);
          }
        }
      ...
      if (struct.isSetMetrics()) {
        {
          ...
          for (MetricEvent _iter52 : struct.metrics)
          {
            _iter52.write(oprot);
          }
        }
      ...
      if (struct.isSetEvents()) {
        {
          ...
          for (Event _iter53 : struct.events)
          {
            _iter53.write(oprot);
          }
        }
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.logEvents = new ArrayList<LogEvent>(_list54.size);
          for (int _i55 = 0; _i55 < _list54.size; ++_i55)
          {
            LogEvent _elem56; // required
            _elem56 = new LogEvent();
            _elem56.read(iprot);
            struct.logEvents.add(_elem56);
          }
        }
        struct.setLogEventsIsSet(true);
      }
      if (incoming.get(5)) {
        {
          ...
          struct.spans = new ArrayList<Span>(_list57.size);
          for (int _i58 = 0; _i58 < _list57.size; ++_i58)
          {
            Span _elem59; // required
            _elem59 = new Span();
            _elem59.read(iprot);
            struct.spans.add(_elem59);
          }
        }
        struct.setSpansIsSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.metrics = new ArrayList<MetricEvent>(_list60.size);
          for (int _i61 = 0; _i61 < _list60.size; ++_i61)
          {
            MetricEvent _elem62; // required
            _elem62 = new MetricEvent();
            _elem62.read(iprot);
            struct.metrics.add(_elem62);
          }
        }
        struct.setMetricsIsSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          struct.events = new ArrayList<Event>(_list63.size);
          for (int _i64 = 0; _i64 < _list63.size; ++_i64)
          {
            Event _elem65; // required
            _elem65 = new Event();
            _elem65.read(iprot);
            struct.events.add(_elem65);
          }
        }
        struct.setEventsIsSet(true);
      }
