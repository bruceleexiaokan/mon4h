...
public class TransferMetrics {
	...
	protected void scan(String namespace,String metricId, long startTime, long endTime) {
		...
		try {
			...
			HTableInterface table = TSDBClient.getMetaHBaseClient().getTable(TSDBClient.getTimeSeriesTableName(namespace));
...
//				TSDBClient.getMetaHBaseClient().put(put).joinUninterruptibly();
	...
	public static void main(String[] args) {
		setHBaseInfo();
		TransferMetrics scanDirect = new TransferMetrics();
		String namespace = null;
		List<String> metricsNames = new ArrayList<String>();
		metricsNames.add("test.sync");
		String start = "2013-06-15 20:00:00";
		String end = "2013-06-15 23:00:00";
		try {
			printCurrentMetrics();
