            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.logEvents = new ArrayList<LogEvent>(_list36.size);
                for (int _i37 = 0; _i37 < _list36.size; ++_i37)
                {
                  LogEvent _elem38; // required
                  _elem38 = new LogEvent();
                  _elem38.read(iprot);
                  struct.logEvents.add(_elem38);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Span struct) throws org.apache.thrift.TException {
      ...
      if (struct.logEvents != null) {
        oprot.writeFieldBegin(LOG_EVENTS_FIELD_DESC);
        {
          ...
          for (LogEvent _iter39 : struct.logEvents)
          {
            _iter39.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetLogEvents()) {
        {
          ...
          for (LogEvent _iter40 : struct.logEvents)
          {
            _iter40.write(oprot);
          }
        }
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.logEvents = new ArrayList<LogEvent>(_list41.size);
          for (int _i42 = 0; _i42 < _list41.size; ++_i42)
          {
            LogEvent _elem43; // required
            _elem43 = new LogEvent();
            _elem43.read(iprot);
            struct.logEvents.add(_elem43);
          }
        }
        struct.setLogEventsIsSet(true);
      }
