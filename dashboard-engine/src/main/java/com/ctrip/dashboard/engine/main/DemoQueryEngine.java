...
import com.ctrip.dashboard.engine.rpc.LifeCycleUtil;
import com.ctrip.dashboard.tsdb.core.TSDBClient;

public class DemoQueryEngine {
	...
	public static void main(String[] args) throws JoranException {
		...
		try {
			LogUtil.setLogbackConfigFile("D:/dashboard/log/queryengine", "D:/projects/ctrip-dashboard/dashboard/dashboard-engine/conf_uat/queryengine-logback.xml");
...
//		NamespaceCheck.init(0);
	...
	private static void configQuery(){
		...
		if(mainConfigFileName == null || mainConfigFileName.length() == 0){
			...
			if(mainConfigFileName == null || mainConfigFileName.length() == 0){
				mainConfigFileName = "D:/projects/ctrip-dashboard/dashboard/dashboard-engine/conf_uat/queryengine.xml";
			}
		}
