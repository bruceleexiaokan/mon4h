 ...
 */
!function ($) {
    $.fn.DashboardBarChart = function (options) {
        new DashboardBarChart(this, options);
    };
    var DashboardBarChart = function (element, options) {
        this.el = $(element);
        this.options = options;
        $.extend(this, this.options);
        this._init();
    }
    DashboardBarChart.prototype = {
        id: "dashboard-data",
        data: null,
        metricName: "",
        namespace: "",
        _init: function () {
            ...
            $("#rending").loading({mask: false,text:"正在渲染柱状图..."}).show();
            var that = this;
