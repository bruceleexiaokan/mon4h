            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.attributes = new ArrayList<Attributes>(_list44.size);
                for (int _i45 = 0; _i45 < _list44.size; ++_i45)
                {
                  Attributes _elem46; // required
                  _elem46 = new Attributes();
                  _elem46.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Event struct) throws org.apache.thrift.TException {
      ...
      if (struct.attributes != null) {
        oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
        {
          ...
          for (Attributes _iter47 : struct.attributes)
          {
            _iter47.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (Attributes _iter48 : struct.attributes)
          {
            _iter48.write(oprot);
          }
        }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.attributes = new ArrayList<Attributes>(_list49.size);
          for (int _i50 = 0; _i50 < _list49.size; ++_i50)
          {
            Attributes _elem51; // required
            _elem51 = new Attributes();
            _elem51.read(iprot);
            struct.attributes.add(_elem51);
          }
        }
        struct.setAttributesIsSet(true);
      }
