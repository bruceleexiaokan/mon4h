...
public class QueryEngineOld {
	private static final Logger log = LoggerFactory.getLogger(QueryEngineOld.class);

	/**
	 * @param args
	 */
	public static void main(String[] args) {
		// [Edward] hack this, because I don't know where to configure force-create
		// there is one force-create in json input request, but it does not work
