            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.appLevel = new HashMap<String,AgentConfig>(2*_map66.size);
                for (int _i67 = 0; _i67 < _map66.size; ++_i67)
                {
                  String _key68; // required
                  AgentConfig _val69; // required
                  _key68 = iprot.readString();
                  _val69 = new AgentConfig();
                  _val69.read(iprot);
                  struct.appLevel.put(_key68, _val69);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.ipLevel = new HashMap<String,AgentConfig>(2*_map70.size);
                for (int _i71 = 0; _i71 < _map70.size; ++_i71)
                {
                  String _key72; // required
                  AgentConfig _val73; // required
                  _key72 = iprot.readString();
                  _val73 = new AgentConfig();
                  _val73.read(iprot);
                  struct.ipLevel.put(_key72, _val73);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AgentConfigContainer struct) throws org.apache.thrift.TException {
      ...
      if (struct.appLevel != null) {
        oprot.writeFieldBegin(APP_LEVEL_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, AgentConfig> _iter74 : struct.appLevel.entrySet())
          {
      ...
      if (struct.ipLevel != null) {
        oprot.writeFieldBegin(IP_LEVEL_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, AgentConfig> _iter75 : struct.ipLevel.entrySet())
          {
      ...
      if (struct.isSetAppLevel()) {
        {
          ...
          for (Map.Entry<String, AgentConfig> _iter76 : struct.appLevel.entrySet())
          {
      ...
      if (struct.isSetIpLevel()) {
        {
          ...
          for (Map.Entry<String, AgentConfig> _iter77 : struct.ipLevel.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.appLevel = new HashMap<String,AgentConfig>(2*_map78.size);
          for (int _i79 = 0; _i79 < _map78.size; ++_i79)
          {
            String _key80; // required
            AgentConfig _val81; // required
            _key80 = iprot.readString();
            _val81 = new AgentConfig();
            _val81.read(iprot);
            struct.appLevel.put(_key80, _val81);
          }
        }
        struct.setAppLevelIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.ipLevel = new HashMap<String,AgentConfig>(2*_map82.size);
          for (int _i83 = 0; _i83 < _map82.size; ++_i83)
          {
            String _key84; // required
            AgentConfig _val85; // required
            _key84 = iprot.readString();
            _val85 = new AgentConfig();
            _val85.read(iprot);
            struct.ipLevel.put(_key84, _val85);
          }
        }
        struct.setIpLevelIsSet(true);
      }
