...
public class DownSampler {
	...
	public static com.mon4h.dashboard.tsdb.core.Aggregator getTsdbDownSamplerAggregator(int funcType){
		switch (funcType) {
		case InterfaceConst.DownSamplerFuncType.SUM:
			return com.mon4h.dashboard.tsdb.core.Aggregators.SUM;
		case InterfaceConst.DownSamplerFuncType.MAX:
			return com.mon4h.dashboard.tsdb.core.Aggregators.MAX;
		case InterfaceConst.DownSamplerFuncType.MIN:
			return com.mon4h.dashboard.tsdb.core.Aggregators.MIN;
		case InterfaceConst.DownSamplerFuncType.DEV:
			return com.mon4h.dashboard.tsdb.core.Aggregators.DEV;
		case InterfaceConst.DownSamplerFuncType.AVG:
			return com.mon4h.dashboard.tsdb.core.Aggregators.AVG;
		case InterfaceConst.DownSamplerFuncType.MID:
			return com.mon4h.dashboard.tsdb.core.Aggregators.MID;
		case InterfaceConst.DownSamplerFuncType.RAT:
			return com.mon4h.dashboard.tsdb.core.Aggregators.RAT;
		default:
			return null;
		}
	}
