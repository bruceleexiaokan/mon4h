...
import com.mon4h.dashboard.tsdb.core.Aggregators;
...
public class Aggregator {
	...
	public static com.mon4h.dashboard.tsdb.core.Aggregator getAggregator(
			int funcType) {
		switch (funcType) {
	...
	public static DataPoints aggregate(List<DataPoints> groupedDataPoints,Aggregator aggreagtor){
		...
		while(hasNext){
			...
			if(find){
				com.mon4h.dashboard.tsdb.core.Aggregator agg = getAggregator(aggreagtor.getFuncType());
				if(isDouble){
